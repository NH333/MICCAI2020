...
double Test(const int gid, int iters)
{
    ...
    int new_action;
        char path1[100];
           double tmp=0;
        sprintf(path1, "/home/chenanqi/graph_comb_opt/data/maxcut/result/actionIndex/%d.txt", iters);
	...
	out1<<"\n";
        std::cout<<"\n";
    char path[100];
    sprintf(path, "/home/chenanqi/graph_comb_opt/data/maxcut/result/nodeIndex/%d.txt", iters);
    ...
    */
	...
	//int min_iter=0;
        if(iter%300 == 0){
            ...
            sprintf(model_path,"/home/chenanqi/graph_comb_opt/data/maxcut/result/modelIndex/%d_iters.model",iter);
