...
double Test(const int gid, int iters)
{
    ...
    char path[100];
    sprintf(path,"/home/chenanqi/graph_comb_opt/data/batch64/nodetxt/test6_emb64/%d.txt",iters);
...
int main(){
    ...
    std::ifstream filename("/home/chenanqi/graph_comb_opt/data/mvc/filename1.txt");
    ...
    std::ifstream test_filename("/home/chenanqi/graph_comb_opt/data/mvc/TestReTest/Test/test_filename.txt");
