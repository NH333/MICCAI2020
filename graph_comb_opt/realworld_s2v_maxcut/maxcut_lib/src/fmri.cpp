...
double Test(const int gid, int iters)
{
    ...
    int new_action;
	char path1[100];
	sprintf(path1, "/home/chenanqi/graph_comb_opt/data/maxcut/result/fmri/actionIndex/%d.txt", iters);
	std::ofstream out1(path1, std::ios::app);
	//double tmp = 0;
    while (!test_env->isTerminal())
    {
        ...
        //if (scores[new_action] < 0)
          //  break;
		//std::cout<<test_env->step(new_action)<<" ";
        v += test_env->step(new_action);
	out1<<new_action<<":"<<test_env->sumEigenValues<<" ";
        //std::cout<<new_action<<":"<<test_env->sumEigenValues<<" ";
		
    }
	out1<<"\n";
        std::cout<<"\n";
    char path[100];
    sprintf(path, "/home/chenanqi/graph_comb_opt/data/maxcut/result/fmri/nodeIndex/%d.txt", iters);
...
int main(){
    ...
    std::ifstream filename("/home/chenanqi/graph_comb_opt/data/maxcut/src_data/fmri/filename_train.txt");
    ...
    std::ifstream test_filename("/home/chenanqi/graph_comb_opt/data/maxcut/src_data/fmri/filename_test.txt");
    ...
    */
	...
	//int min_iter=0;
        if(iter%300 == 0){
            ...
            sprintf(model_path,"/home/chenanqi/graph_comb_opt/data/maxcut/result/fmri/modelIndex/%d_iters.model",iter);
